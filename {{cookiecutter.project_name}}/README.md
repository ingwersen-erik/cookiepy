...
You can install _{{cookiecutter.friendly_name}}_ via [pip]:
...
When installing the _{{cookiecutter.friendly_name}}_, it might be a good idea to install
it in a specific Python environment. By default, _{{cookiecutter.friendly_name}}_
...
_{{cookiecutter.friendly_name}}_. Consider adding small videos in the form of
...
A guideline is about consistency. Consistency with this
contribution guideline is important. Consistency within a project is more
important. However, know when to be inconsistent.
**When in doubt, use your best judgment.**[1].

[1]: phrase borrowed and modified from [PEP 8 - A Foolish Consistency is the Hobgoblin of Little Minds](https://peps.python.org/pep-0008/#a-foolish-consistency-is-the-hobgoblin-of-little-minds)
...
_{{cookiecutter.friendly_name}}_ is {%- if cookiecutter.license != 'Proprietary' %} free and open source software.
